...
<head>
  ...
  <link rel="stylesheet" href="/css/table.css" media="screen" charset="utf-8">
</head>
<body>
      ...
      <table class="table">
        ...
        <?php
          ...
          for($x=0; $x<count($teams); $x++ ){
            ...
            $crestPath = '/logos/16/'.strtolower(preg_replace("/[^a-zA-Z0-9\-]+/", "", html_entity_decode(str_replace(" ", "-", $teams[$x]["club"]), ENT_QUOTES))).'.png';
            $crest = "";
